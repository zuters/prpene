...
from prpe_ne import unprocess_prpe_ne_translate
...
def create_parser():
    ...
    parser.add_argument(
        ...
        metavar='PATH',
        help="Intput file of line numbers and numbers of named entities")
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    unprocess_prpe_ne_translate(args.input,args.output,args.nelines,args.marker1,args.marker2,args.mode)
