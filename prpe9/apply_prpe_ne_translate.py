...
"""Use operations learned with learn_prpe.py to encode a new text with named-entity processing in translation phase.
"""
...
from prpe_ne import apply_prpe_ne_translate

def create_parser():
    parser = argparse.ArgumentParser(
        formatter_class=argparse.RawDescriptionHelpFormatter,
        description="do PRPE segmentation")
    parser.add_argument(
    ...
    parser.add_argument(
        '--nelines', '-e', type=argparse.FileType('w'),
        metavar='PATH',
        help="Output file of line numbers of named-entities")
    parser.add_argument(
...
if __name__ == '__main__':
    ...
    args.nelines = codecs.open(args.nelines.name, 'w', encoding='utf-8')

    apply_prpe_ne_translate(args.input, args.output,
            args.prefixes, args.roots, args.suffixes, args.postfixes, args.endings, args.words, args.nelines,
